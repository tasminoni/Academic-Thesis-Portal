                  ...
                  <div className="hidden md:flex items-center space-x-4">
                    ...
                    >
                      ...
                      {unreadNotifications > 0 && (
                        <span className="ml-2 relative inline-flex items-center justify-center">
                          <div className="absolute inset-0 rounded-full bg-blue-400 animate-ping opacity-30 pointer-events-none z-0"></div>
                          <span className="bg-blue-600 text-red-500 text-xs font-bold rounded-full h-5 min-w-[1.25rem] px-1 flex items-center justify-center shadow-lg border-2 border-blue-600 z-10">
                            {unreadNotifications}
                          </span>
                        </span>
                      )}
            ...
            {isAuthenticated && user?.role !== 'admin' && (
              <div className="relative">
                ...
                >
                  ...
                  {unreadNotifications > 0 && (
                    <span className="ml-1 relative inline-flex items-center justify-center align-middle">
                      <div className="absolute inset-0 rounded-full bg-blue-400 animate-ping opacity-30 pointer-events-none z-0"></div>
                      <span className="bg-blue-600 text-red-500 text-[10px] font-bold rounded-full h-4 min-w-[1rem] px-1 inline-flex items-center justify-center shadow-md border border-blue-600 z-10">
                        {unreadNotifications}
                      </span>
                    </span>
                  )}
